...
public class yapilacakislem extends AppCompatActivity implements View.OnClickListener {
    ...
    public void save(View view){
        ...
        try {
            ...
            database.execSQL("CREATE TABLE IF NOT EXISTS todo (id INTEGER PRIMARY KEY, todoname VARCHAR, aciklamalar VARCHAR, date VARCHAR, image BLOB)");
            String sqlString ="INSERT INTO todo (todoname,aciklamalar,date,image) VALUES(?,?,?,?)";
